...
%%%%%%%%%%
%Bug1: Data var changed to Data in the following line. Windows is caps
%insensitive but Unix systems aren't (I believe).
%%%%%%%%%%
N = size(Data,1); V = size(Data,2); %% N : instances, V : dimension 
%%%%%%%%%%
%Change1: labels vector is called truth in the .mat files
%%%%%%%%%%
labels = truth;
...
t_Recovery = toc(t_Recovery_Start);
save('./timing/t_Recovery', 't_Recovery');

%%%%
% Bug2: Changed writing == 1 to inputs.writing == 1. writing is an inputs
% parameter.
%%%%
if inputs.writing == 1 
    outputs.U = U_hat; 
